...
export const portfolioCategories: PortfolioCategory[] = [
  {
    ...
    images: [
      { src: `${basePath}/frameless-90/1633fbe6-4376-4198-88c3-c63d2b363840.webp`, alt: 'Frameless 90° shower enclosure' },
      ...
      { src: `${basePath}/frameless-90/IMG_2351-scaled.webp`, alt: 'Bathroom glass enclosure' },
      { src: `${basePath}/frameless-90/IMG_3296-scaled.webp`, alt: 'Premium shower glass' },
  ...
  },
  {
    ...
    serviceId: 'frameless-shower',
    images: [
      { src: `${basePath}/frameless-80/1237999a-eacf-4958-9e21-57518c81bb1d.webp`, alt: '80° frameless shower enclosure' },
      { src: `${basePath}/frameless-80/55cb5fa3-4b4f-4eed-9d31-2bd0f6eb76a0.webp`, alt: 'Angled shower glass door' },
      { src: `${basePath}/frameless-80/IMG_3442-rotated.webp`, alt: 'Custom 80 degree shower' },
      { src: `${basePath}/frameless-80/IMG_5982.jpeg-1-scaled.webp`, alt: 'Frameless shower glass 80°' },
      { src: `${basePath}/frameless-80/IMG_6314-rotated.jpeg-1-scaled.webp`, alt: 'Modern glass shower enclosure' },
  ...
  },
  {
    ...
    serviceId: 'frameless-shower',
    images: [
      { src: `${basePath}/sliding/6a551f46-4f47-4e44-b956-86e3a6eb64e7.webp`, alt: 'Sliding shower glass door' },
  ...
  },
  {
    ...
    images: [
      ...
      { src: `${basePath}/steam/IMG_5682.jpeg.webp`, alt: 'Steam shower enclosure' },
    ],
  },
  {
    id: 'tub-glass',
    ...
    serviceId: 'frameless-shower',
    images: [
      { src: `${basePath}/tub/1f0c396d-eb8b-4d2c-9583-fbe27e2fba3c-1.webp`, alt: 'Glass tub enclosure' },
      { src: `${basePath}/tub/53d5249c-daab-49f9-b39d-7ef18820b58b.webp`, alt: 'Bathtub glass door' },
  ...
  },
  {
    ...
    images: [
      ...
      { src: `${basePath}/mirrors/Imagen-de-WhatsApp-2023-10-24-a-las-14.05.36-1-scaled-1.webp`, alt: 'Large custom mirror' },
  ...
  },
  {
    ...
    images: [
      { src: `${basePath}/commercial/Commercial-Glass-1.webp`, alt: 'Office glass partition' },
      { src: `${basePath}/commercial/Commercial-Glass-3.webp`, alt: 'Commercial glass wall' },
      { src: `${basePath}/commercial/Commercial-Glass-5.webp`, alt: 'Glass office partition Dallas' },
      { src: `${basePath}/commercial/Commercial-Glass-6.webp`, alt: 'Modern office glass dividers' },
    ],
  },
  {
    id: 'frameless-doors',
  ...
  },
  {
    ...
    images: [
      ...
      { src: `${basePath}/shelving/2b9ebff5-5b53-4bd3-9ed5-f85b589e6a11.webp`, alt: 'Glass shelf installation' },
  ...
  },
  {
    ...
    serviceId: 'residential-glass',
    images: [
      { src: `${basePath}/furniture/0eeef76a-6646-4953-99d3-a811ff827c5b.webp`, alt: 'Glass table top custom' },
  ...
  },
  {
    ...
    serviceId: 'windows',
    images: [
      { src: `${basePath}/windows/42b1f654-2621-4314-af7d-b6a4cc8a7160.webp`, alt: 'Window replacement Dallas TX' },
